...
public class CoinCounterLevel3 : MonoBehaviour
{
    public TextMeshProUGUI coinText; // Assign the TextMeshProUGUI from the Inspector
    public int totalCoins = 20; // Total coins in the level
    private int currentCoins = 0; // Collected coins

    public WinScreenLevel3 victoryScreen;
    public TimerLevel3 timer; // Reference to the Timer script
